...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-yvonne-kuo/manhattan.csv")
```
...
**Interpretation**: We are 95% confident that the mean price of 1 bedroom Manhattan apartments is between 2299 and 2977 dollars.
...
We are 95% confident that the median price of 1 bedroom Manhattan apartments is between 2162 and 2875 dollars.
...
- Parameter of interest: Proportion that died
...
We are 95% confident that the proportion of mice that died while not on treatment is between 0.690 and 0.793.
...
We are 90% confident that the proportion of mice that lived on the treatment is between 0.552 and 0.651.
